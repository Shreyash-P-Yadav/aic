"""The statistical eval sections: calibration, attribution, detection, elasticity.

One function per measured area, so a failing gate names one thing rather than "the
suite". The delivery-side sections — narration, entitlements, budget — live in
:mod:`insight_copilot.evals.sections_delivery`.
